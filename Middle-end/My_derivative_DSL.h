...
#define CNODE_FUNC(name, num, arg) Node_create_and_fill(arg,                      \
                                                        FUNC, name, num, nullptr, \
                                                        nullptr)

#define dL My_derivative(tree, LNODE)
#define dR My_derivative(tree, RNODE)
#define d(node) My_derivative(tree, node)
